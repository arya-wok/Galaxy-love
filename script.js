...
const defaultHeartImages = Array.from({ length: 5 }, (_, i) => `images/img${i + 1}.gif`);
...
const ringTexts = [
  'Galaxy of love From Arya',//untuk deskripsi planet layer 1
  "I love you Keyodd",//untuk deskripsi planet layer 2
  "♡Happy Birth Day♡",//untuk deskripsi planet layer 3
  "22/06/2026",//untuk deskripsi planet layer 4
